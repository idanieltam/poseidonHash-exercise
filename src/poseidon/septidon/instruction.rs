...
use halo2_proofs::{arithmetic::FieldExt, dev::metadata::Constraint};
use halo2_proofs::{
...
impl<F:CachedConstants,S:Spec<F,WIDTH,RATE>> PermuteChip<F,S,WIDTH,RATE> for SeptidonChip {
    fn configure(meta: &mut ConstraintSystem<F>) -> Self::Config {
        ...
        // Enable equality constraint on the input and output columns, required by the function permute
    ...
    fn permute(
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                //Return the cells with final state
