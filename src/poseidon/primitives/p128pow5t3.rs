...
// The trait required for fields can handle a pow5 sbox, 3 field (capacity) + 2 rate permutations
...
mod tests {
    ...
    use crate::poseidon::primitives::{Spec,permute, Hash, ConstantLength};

    #[derive(Debug)]
    pub struct P128Pow5T3Gen<F:FieldExt, const SECURE_MDS: usize> (PhantomData<F>); 

    type P128Pow5T3Pasta = P128Pow5T3Gen<Fp>;
