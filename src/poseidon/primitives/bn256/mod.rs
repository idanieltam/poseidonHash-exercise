pub(crate) use halo2_proof::halo2curve::bn256::Fr as Fp;

use super::p128pow5t3::P128Pow5T3;
use super::Mds;
...
mod tests {
    ...
    // the same Poseidon spec as poseidon::P128Pow5T3, but constructed such that its constanty will be generated at runtime
